...
BULLET_HIT_SOUND = pygame.mixer.Sound("Assets/collision.wav")
BULLET_FIRE_SOUND = pygame.mixer.Sound("Assets/fire.wav")
BCMUSIC_SOUND = pygame.mixer.Sound("Assets/bcmusic.wav")
...
YELLOW_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(YELLOW_SPACESHIP_IMG, (SPACESHIP_HEIGHT, SPACESHIP_WIDTH)), 90)

RED_SPACESHIP_IMG = pygame.image.load(os.path.join("Assets", "spaceship_red.png"))
RED_SPACESHIP = pygame.transform.rotate(pygame.transform.scale(RED_SPACESHIP_IMG, (SPACESHIP_HEIGHT, SPACESHIP_WIDTH)), 270)
...
def main(yellow_health, red_health):
    BCMUSIC_SOUND.play()
